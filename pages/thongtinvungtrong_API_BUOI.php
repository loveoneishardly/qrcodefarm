            ...
            <?php
                ...
                if ($data1["code"] == 200) {
                    ...
                    if (isset($data1["object"]["thongTinSanXuat"]["dtSxBuoi"])) {
                        echo '<p><b>4. Thông tin sản phẩm:</b> '.$data1["object"]["thongTinSanXuat"]["dtSxBuoi"].'</p>';
                    } else {
        ...
        <div class="w3-col">
            ...
            <?php
                ...
                if ($data2["code"] == 200) {
                    ...
                    echo '<p class="c-title1">2. Thông tin đất sản xuất</p>';
                    if (isset($data2["object"]["thongTinChung"]["dienTichBuoiHA"])){
                        echo '<p class="c-title5">- Diện tích canh tác: '.$data2["object"]["thongTinChung"]["dienTichBuoiHA"].' ha</p>'; 
                    } else {
                    ...
                    if (isset($data2["object"]["thongTinSanXuat"]["ph"])) {
                        echo '<p class="c-title3">+ Độ PH: '.$data2["object"]["thongTinSanXuat"]["ph"].'</p>';
                    } else {
                    ...
                    if (isset($data2["object"]["thongTinSanXuat"]["giongBuoiGanNhat"])) {
                        echo '<p class="c-title3">+ Giống bưởi được trồng gần nhất: '.$data2["object"]["thongTinSanXuat"]["giongBuoiGanNhat"].'</p>';
                    } else {
                        echo '<p class="c-title3">+ Giống bưởi được trồng gần nhất: </p>';
                    }
                    if (isset($data2["object"]["thongTinSanXuat"]["nguonGocGiong"])) {
                        echo '<p class="c-title3">+ Nguồn gốc giống: '.$data2["object"]["thongTinSanXuat"]["nguonGocGiong"].'</p>';
                    } else {
                        echo '<p class="c-title3">+ Nguồn gốc giống:</p>';
                    }
                    if (isset($data2["object"]["thongTinSanXuat"]["giayXnNgGiong"])) {
                        if ($data2["object"]["thongTinSanXuat"]["giayXnNgGiong"] == "1") {
                            echo '<p class="c-title3">+ Giấy xác nhận nguồn gốc giống bưởi: Có</p>';
                        } else {
                            echo '<p class="c-title3">+ Giấy xác nhận nguồn gốc giống bưởi: Không</p>';
                        }
                    } else {
                        echo '<p class="c-title3">+ Giấy xác nhận nguồn gốc giống bưởi:</p>';
                    }
                    if (isset($data2["object"]["thongTinSanXuat"]["coXuLyGiong"])) {
                        if ($data2["object"]["thongTinSanXuat"]["coXuLyGiong"] == "1"){
                            echo '<p class="c-title3">+ Xử lý cây giống: Có. Chế phẩm xử lý: '.$data2["object"]["thongTinSanXuat"]["chePhamXuLy"].'</p>';
                        }
                    } else {
                        echo '<p class="c-title3">+ Xử lý cây giống: </p>';
                    }
                    if (isset($data2["object"]["thongTinSanXuat"]["mdXuLyCay"])) {
                        echo '<p class="c-title3">+ Mục đích xử lý cây giống để làm gì? '.$data2["object"]["thongTinSanXuat"]["mdXuLyCay"].'</p>';
                    } else {
                        echo '<p class="c-title3">+ Mục đích xử lý cây giống để làm gì?</p>';
                    }
                    ...
                    if (isset($data2["object"]["thuHoach"]["thGianThuHoach"])){
                        echo '<p class="c-title3">+ Thời gian từ khi đậu trái đến khi thu hoạch( ngày hay tháng): '.$data2["object"]["thuHoach"]["thGianThuHoach"].' kg/ha</p>';
                    } else {
                        echo '<p class="c-title3">+ Thời gian từ khi đậu trái đến khi thu hoạch( ngày hay tháng): </p>';
                    }

                    if (isset($data2["object"]["thuHoach"]["dacDiemThuHoach"])){
                        echo '<p class="c-title3">+ Đặc điểm nhận biết trái có thể thu hoạch được: '.$data2["object"]["thuHoach"]["dacDiemThuHoach"].' kg/ha</p>';
                    } else {
                        echo '<p class="c-title3">+ Đặc điểm nhận biết trái có thể thu hoạch được: </p>';
                    }
                    if (isset($data2["object"]["thuHoach"]["soLanThuHoach"])){
                        echo '<p class="c-title3">+ Số lần thu hoạch( lần): '.$data2["object"]["thuHoach"]["soLanThuHoach"].' kg/ha</p>';
                    } else {
                    ...
                    if (isset($data2["object"]["thuHoach"]["nangSuatMuaThuan"])){
                        ...
                        echo '<p class="c-title3"> Mùa thuận: '.$data2["object"]["thuHoach"]["nangSuatMuaThuan"].'</p>';
                        echo '<p class="c-title3"> Mùa nghịch: '.$data2["object"]["thuHoach"]["nangSuatMuaNghich"].'</p>';
                    } else {
                        echo '<p class="c-title3">+ Năng suất( kg/cây/năm): </p>';
                    ...
                    if (isset($data2["object"]["thuHoach"]["sanLuongMuaThuan"])){
                        ...
                        echo '<p class="c-title3"> Mùa thuận: '.$data2["object"]["thuHoach"]["sanLuongMuaThuan"].'</p>';
                        echo '<p class="c-title3"> Mùa nghịch: '.$data2["object"]["thuHoach"]["sanLuongMuaNghich"].'</p>';
                    } else {
                        echo '<p class="c-title3">+ Sản lượng( tấn/năm): </p>';
                        echo '<p class="c-title3"> Mùa thuận:.....</p>';
                        echo '<p class="c-title3"> Mùa nghịch:....</p>';
                    ...
                    if (isset($data2["object"]["thiTruongTieuThu"]["thiTruongThieuThu"])){
                        echo '<p class="c-title3">+ '.$data2["object"]["thiTruongTieuThu"]["thiTruongThieuThu"].'</p>';
                    } else {
                        echo '<p class="c-title3"></p>';
                    }
                    if (isset($data2["object"]["thiTruongTieuThu"]["tinhNgoai"])){
                        echo '<p class="c-title3">+ Thị trường ngoài tỉnh( tỉnh, khu vực nào)? '.$data2["object"]["thiTruongTieuThu"]["tinhNgoai"].'</p>';
                    } else {
