            ...
            <?php
                ...
                if ($data2["code"] == 200) {
                    ...
                    if (isset($data2["object"]["kyThuatBonPhan"]["pHCTong"])) {
                        ...
                        echo '<p class="c-title6">• Bón lót: '.$data2["object"]["kyThuatBonPhan"]["pHCBonLot"].'</p>';
                        echo '<p class="c-title6">• Lần 1: '.$data2["object"]["kyThuatBonPhan"]["pHCLan1"].'</p>';
                        echo '<p class="c-title6">• Lần 2: '.$data2["object"]["kyThuatBonPhan"]["pHCLan2"].'</p>';
                        echo '<p class="c-title6">• Lần 3: '.$data2["object"]["kyThuatBonPhan"]["pHCLan3"].'</p>';
                        echo '<p class="c-title6">• Lần 4: '.$data2["object"]["kyThuatBonPhan"]["pHCLan4"].'</p>';
                        echo '<p class="c-title6">• Lần 5: '.$data2["object"]["kyThuatBonPhan"]["pHCLan5"].'</p>';
                    ...
                    if (isset($data2["object"]["kyThuatBonPhan"]["pCTDTong"])) {
                        ...
                        echo '<p class="c-title6">• Bón lót: '.$data2["object"]["kyThuatBonPhan"]["pCTDBonLot"].'</p>';
                        echo '<p class="c-title6">• Lần 1: '.$data2["object"]["kyThuatBonPhan"]["pCTDLan1"].'</p>';
                        echo '<p class="c-title6">• Lần 2: '.$data2["object"]["kyThuatBonPhan"]["pCTDLan2"].'</p>';
                        echo '<p class="c-title6">• Lần 3: '.$data2["object"]["kyThuatBonPhan"]["pCTDLan3"].'</p>';
                        echo '<p class="c-title6">• Lần 4: '.$data2["object"]["kyThuatBonPhan"]["pCTDLan4"].'</p>';
                        echo '<p class="c-title6">• Lần 5: '.$data2["object"]["kyThuatBonPhan"]["pCTDLan5"].'</p>';
                    ...
                    if (isset($data2["object"]["kyThuatBonPhan"]["ureTong"])) {
                        ...
                        if(isset($data2["object"]["kyThuatBonPhan"]["ureBonLot"])){
                            echo '<p class="c-title6">• Bón lót: '.$data2["object"]["kyThuatBonPhan"]["ureBonLot"].'</p>';
                        } else {
                    ...
                    if (isset($data2["object"]["kyThuatBonPhan"]["pLanTong"])) {
                        ...
                        if(isset($data2["object"]["kyThuatBonPhan"]["pLanBonLot"])){
                            echo '<p class="c-title6">• Bón lót: '.$data2["object"]["kyThuatBonPhan"]["pLanBonLot"].'</p>';
                        } else {
                            echo '<p class="c-title6">• Bón lót: Không</p>';
                        }
                    ...
                    if (isset($data2["object"]["kyThuatBonPhan"]["pkaliTong"])) {
                        ...
                        if(isset($data2["object"]["kyThuatBonPhan"]["pkaliBonLot"])){
                            echo '<p class="c-title6">• Bón lót: '.$data2["object"]["kyThuatBonPhan"]["pkaliBonLot"].'</p>';
                        } else {
                            echo '<p class="c-title6">• Bón lót: Không</p>';
                        }
                    ...
                    if (isset($data2["object"]["kyThuatBonPhan"]["phNpkTong"])) {
                        ...
                        if(isset($data2["object"]["kyThuatBonPhan"]["phNpkBonLot"])){
                            echo '<p class="c-title6">• Bón lót: '.$data2["object"]["kyThuatBonPhan"]["phNpkBonLot"].'</p>';
                        } else {
                            echo '<p class="c-title6">• Bón lót: Không</p>';
                        }
                    ...
                    if (isset($data2["object"]["kyThuatBonPhan"]["phKhacTong"])) {
                        ...
                        if(isset($data2["object"]["kyThuatBonPhan"]["phKhacBonLot"])){
                            echo '<p class="c-title6">• Bón lót: '.$data2["object"]["kyThuatBonPhan"]["phKhacBonLot"].'</p>';
                        } else {
                            echo '<p class="c-title6">• Bón lót: Không</p>';
                        }
                    ...
                    if (isset($data2["object"]["kyThuatBonPhan"]["phBLTong"])) {
                        ...
                        if(isset($data2["object"]["kyThuatBonPhan"]["phBLBonLot"])){
                            echo '<p class="c-title6">• Bón lót: '.$data2["object"]["kyThuatBonPhan"]["phBLBonLot"].'</p>';
                        } else {
                            echo '<p class="c-title6">• Bón lót: Không</p>';
                        }
